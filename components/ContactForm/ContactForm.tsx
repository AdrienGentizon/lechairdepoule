  ...
  return (
    <>
      ...
      {open && (
        <form
          ref={formRef}
          className="relative flex w-full max-w-md flex-col gap-4 bg-black px-4 pt-4 pb-8 sm:px-0"
        ...
        >
          <button
            className="absolute top-0 right-4 cursor-pointer rounded-full bg-white p-1 sm:right-0"
