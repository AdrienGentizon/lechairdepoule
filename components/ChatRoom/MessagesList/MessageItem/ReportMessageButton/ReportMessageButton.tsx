  ...
  return (
    <Dialog open={openReport} onOpenChange={setOpenReport}>
      <DialogTrigger
        ...
        className="inline-flex h-full cursor-pointer items-center gap-1 rounded-t-sm border-t border-r border-l border-white px-2 text-xs hover:text-purple-300 disabled:hidden"
      >
